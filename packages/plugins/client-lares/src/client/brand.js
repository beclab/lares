...
import { PRODUCT_NAME } from "../../../bundle-web/host/brand/identity.js";
import { MARK_PATH } from "../../../bundle-web/host/brand/mark.js";
...
/** Upstream's hardcoded title, matched only to be replaced by {@link PRODUCT_NAME}. */
...
export function keepProductTitle() {
  const rebrand = () => {
    const branded = document.title.split(UPSTREAM_TITLE).join(PRODUCT_NAME);
