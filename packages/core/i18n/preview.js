export const ZH = {
  ...
  unsupported: "目前支持图片、PDF、音视频、3D 模型、Markdown 和文本文件。",
  model3dHint: "3D 预览在电脑端打开。可先下载此文件。",
...
export const EN = {
  ...
  unsupported: "Images, PDF, audio, video, 3D models, Markdown, and text files are supported.",
  model3dHint: "3D preview is available on desktop. You can download this file.",
