/**
 * Host routes for Olares: readiness probe + LLM gateway shim.
 * DEEPSEEK_BASE_URL should point at http://127.0.0.1:$PORT/llm/v1.
 */
...
export function apply(ctx) {
  ...
  ctx.webServer.tapIndex((html) =>
    html.replace(/<title>[^<]*<\/title>/i, "<title>Dina</title>").replace(
      /<\/head>/i,
      '<meta name="dina-shell" content="dsh-web" /></head>',
    ),
  );
}
